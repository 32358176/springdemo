...
public class FileSystemStorageService {
     ...
     * 文件上传类,返回一个全新的路径
     */
    public Page store(MultipartFile multipartFile) throws CustomException {
        if (multipartFile == null || multipartFile.isEmpty()) {
            throw new CustomException(204, "上传文件为空");
        }
        try {
...
//            return data + File.separator + suffixName;
     ...
     * @return
     */
    public Resource loadAsResource(String fileName) throws CustomException {
        /**
         * 得到文件路径对象
         */
